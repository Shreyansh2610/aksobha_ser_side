...
<div class="bg-success py-3 py-md-5 vh-100 d-flex align-items-center">
    <div class="container">
            ...
            <div class="row gy-3 mb-5">
              <div class="col-12">
                <div class="text-center">
                  <a href="#!">
                    <img src="https://aksobha.com/cdn/shop/files/aksobha-logo_420x.png" alt="BootstrapBrain Logo" width="175" height="57">
                  </a>
                </div>
              </div>
              <div class="col-12">
              ...
              <div class="row gy-3 gy-md-4 overflow-hidden">
                <div class="col-12">
                  ...
                  <div class="input-group border border-success rounded">
                    ...
                    <input type="email" class="form-control border border-success rounded" placeholder="Enter Email" name="email" id="email">
                  </div>
                </div>
                <div class="col-12">
                  <div class="d-grid">
