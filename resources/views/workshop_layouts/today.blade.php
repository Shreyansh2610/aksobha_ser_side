<div class="content-height">
    <div class="d-flex align-items-center justify-content-center">
        <span class="h3" style="color: #509e7a">FAQ</span>
    </div>
    <br>
    <input type="text" name="search_area" class="form-control m-2" placeholder="Enter FAQ"
        data-href="{{ route('faq', ['id' => $workshop->id]) }}" value="{{ optional($request)->search }}">
    ...
    <div class="m-2">
        @forelse ($workshop->faqs->groupBy('day') as $faqs)
            <div class="container my-5" style="border-bottom-color: rgb(233, 255, 233);">
                ...
                <div class="accordion accordion-header-primary" id="accordion_day_{{ $faqs->first()->day }}"
                    style="background-color: rgb(233, 255, 233);">
                    @foreach ($faqs as $faq)
